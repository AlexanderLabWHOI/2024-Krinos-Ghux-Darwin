...
OUTPUTDIR="compare_plots_fixed_het"
os.system("mkdir -p "+OUTPUTDIR)
staticwidthsdir="/proj/omics/alexander/akrinos/2023-Krinos-Ghux-Darwin/data/Darwin_Simulations/StaticWidths_FixedHet_MostConservative"
